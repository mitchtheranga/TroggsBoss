...
public class GoonSkeletonStrength extends EntitySkeleton {

    public GoonSkeletonStrength(Location loc){
        ...
        this.addEffect(new MobEffect(MobEffects.INCREASE_DAMAGE, 1000000, 3, true, true));
    }
}
